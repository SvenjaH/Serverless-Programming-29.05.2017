...
var IDENTITY_POOL_ID = 'eu-central-1:e77fecef-c22a-4b09-9d76-d7fbaaa99206';
...
result.innerHTML = getAlert('warning',
...
'</div>' +
'<div class="form-group">' +
'<label class="control-label col-sm-2" for="is-public">Public</
label>' +
'<div class="col-sm-10">' +
'<input type="checkbox" value="" name="is-public" id="ispublic"
...
'<button type="submit" class="btn btn-default"> Add Picture</
button>' +
'<button type="button" id="logout-button" class="btn btndefault">
Logout</button>' +
'</div>' +
'</div>' +
'</form>';
...
(element.isOwner ? '<button type="button" class="close"
