...
IdentityPoolId: 'eu-central-1:555acae9-35c0-43e6-be62-9dd5c28be774'
});
...
if (output.created) {
result.innerHTML = 'User ' + input.email + ' created. Please check
your email to validate the user and enable login.';
} else {
